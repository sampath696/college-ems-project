...
if(isset($_REQUEST['fid'])){
	$faqid=intval($_GET['fid']);
	
	$sql = "DELETE FROM tblissues where id = $faqid";
	$query = $dbh->prepare($sql);
	$query->execute();
...
<head>
    <title>EMS | Admin manage Issues</title>
...
{				?>
                                <tr>
                                    ...
                                    <td><a href="manageissues.php?fid=<?php echo htmlentities($result->id);?>"
                                            onclick="return confirm('Do you really want to remove from FAQ')">Delete
                                        </a>
                                    </td>
