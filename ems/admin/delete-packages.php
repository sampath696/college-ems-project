...
header('location:index.php');
    ...
    if(isset($_REQUEST['pid'])){
        $faqid=intval($_GET['pid']);
        
        $sql = "DELETE FROM tbltourpackages where PackageId = $faqid";
...
{				?>
                                <tr>
                                    ...
                                    <td><a href="delete-packages.php?pid=<?php echo htmlentities($result->PackageId);?>"
                                            onclick="return confirm('Do you really want to remove from Package')"><button
                                                type="button" class="btn btn-primary btn-block">Delete
                                                Package</button></a></td>
                                </tr>
                                <?php $cnt=$cnt+1;} }?>
                            </tbody>
