...
$sql="INSERT INTO bckstageimage(images) VALUES(:pimage)";
...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>insert back stage images
                </li>
            </ol>
            <!--grid-->
            <div class="grid-form">
                ...
                <div class="grid-form1">
                    <h3>Insert Background Stage Image</h3>
